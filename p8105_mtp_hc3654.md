...
| male   |  74 |       15.00 | 15-20mm eop size | 10-15mm eop size |
| male   |  38 |       15.00 | 15-20mm eop size | 10-15mm eop size |
| male   |  53 |       31.10 | 20-25mm eop size | 25+mm eop size   |
| male   |  24 |       35.70 | 20-25mm eop size | 25+mm eop size   |
| male   |  64 |       25.40 | 20-25mm eop size | 25+mm eop size   |
| male   |  23 |       26.80 | 20-25mm eop size | 25+mm eop size   |
| male   |  48 |       23.50 | 25+mm eop size   | 20-25mm eop size |
| male   |  39 |       22.90 | 25+mm eop size   | 20-25mm eop size |
| female |  28 |        0.00 | 5-10mm eop size  | 0-5mm eop size   |
| male   |  42 |       10.00 | 10-15mm eop size | 5-10mm eop size  |
| male   |  61 |       14.60 | 15-20mm eop size | 10-15mm eop size |
| female |  64 |        5.00 | 5-10mm eop size  | 0-5mm eop size   |
| female |  68 |        5.00 | 5-10mm eop size  | 0-5mm eop size   |
| male   |  61 |        5.00 | 5-10mm eop size  | 0-5mm eop size   |
| female |  61 |       12.10 | 15-20mm eop size | 10-15mm eop size |
...
categorical variables. I found errors in eop_size, in age_group, and 8
in fhp_category. Raw dataset most of people in age between in 70-80 is
in Age group 7, consider the 86 belong to 7 is a mistake.
...
(EEOP) rate increases with age and is higher in males, contradicting the
original conclusio
...
between EOP and FHP size. Resulting trend lines indicate a clear
...
Most of age_groups number is different to author mentions in article.
51-60 age is exact same.
...
The avarage fhp size for male and female is close to the author mentions
in the article.
...
Crucially, the dataset lacks any mobile usage data, making it impossible
to prove the link between phones and “horns.” Future studies must
include this data.
